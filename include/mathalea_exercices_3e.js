			...
			switch (choix) {
				case 1 : // calcul de l'aire de base, du volume d'une pyramide à base carrée. puis, calcul de la section, du volume de la petite pyramide et du volume du tronc
					...
					this.MG32code_pour_modifier_la_figure = `
							...
							` 	
						break;
				case 2 : // calcul de l'aire de base, du volume d'un cônee. puis, calcul de la section, du volume du cône réduit et du volume du tronc
					r=randint(12,35)/10
					h1=randint(12,20)/2
					h2=randint(3,Math.floor(h1)-1)
				...
				case 3 : // calcul de l'aire de base, du volume d'une pyramide à base triangulaire. puis, calcul de la section, du volume de la petite pyramide et du volume du tronc
					...
					case 4 : // Un tronc de cône étant donné (seau), calcul de la hauteur du cône dont il est issu, de son volume, puis du volume du seau. Lecture graphique du volume d'eau à mi hauteur et calcul de ce volume
						...
						texte +=`Sa hauteur intérieur est de ${tex_nombre(h1-h2)} dm, sa petite base a un dimaètre intérieur de ${tex_nombre(r2*2)} dm et sa brande base (l'ouverture) a un diamètre intérieur de ${tex_nombre(r*2)} dm.<br>`
						...
						texte_corr += `$VolumeCône - VolumeCôneRéduit$<br>Soit : <br>$\\dfrac{${tex_nombrec(r*r*h1)}}{3}\\pi$ cm${exposant(3)}$ - \\left(${tex_fraction_reduite(arrondi(r2*10),arrondi(r*10))}\\right)^3 \\times \\dfrac{${tex_nombrec(r*r*h1)}}{3}\\pi$ cm${exposant(3)} `
