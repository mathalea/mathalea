		...
		if (sortie_html) {
			...
			switch (choix) {
				...
				case 2 :
					...
					texte_corr +=`Dans une réduction de rapport k, les aires sont multipliés par k ${exposant(2)}.<br>`
