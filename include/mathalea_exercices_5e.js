...
//	this.sup = 1; // 1 pour symétrie axiale, 2 pour symétrie centrale, 3 pour translations, et 4 pour rotations ; paramètre fixé par les variantes respectives.
	...
	switch (parseInt(this.sup)) {
		case 1:
			pave=paves[choice([0,7])] // pavages adaptés à symétrie axiale
			break
		case 2:
			pave=paves[randint(1,1)] // pavages adaptés à symétrie centrale (tous)
			break
		case 3:
	...
	let point=[0,0,0]
	let trouver=false,indexA,numA,indexcentre1,numcentre1,xmil1,ymil1,indexD,numD,indexcentre2,numcentre2,xmil2,ymil2,indexC,numC,indexcentre3,numcentre3,xmil3,ymil3,num1,num2,num3
	let xc,yc,xb,yb,xa,ya,xV1,yV1,xV2,yV2,xV3,yV3
