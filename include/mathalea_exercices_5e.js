...
function Calculer_une_expression_litteraleBis() {
	...
	this.sup=false
	this.version=5 // 1 pour ecrire une expression, 2 pour écrire la phrase, 3 pour écrire l'expression et la calculer, 4 pour calculer une expression numérique
	this.litteral = true;
	...
	this.nouvelle_version = function(numero_de_l_exercice){
		...
		type_de_questions_disponibles = [2,3,4,5]
		}
		else {
