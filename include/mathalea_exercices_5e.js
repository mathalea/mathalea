...
function Pavages_et_demi_tour() {
	...
	let s0 = choice([`S`,`X`,`T`,`L`,`W`,`R`,`G`,`E`,`F`,`G`,`K`])
	let s1 = choice([`S`,`X`,`T`,`L`,`W`,`R`,`G`,`E`,`F`,`G`,`K`],[s0])
	let s2 = choice([`S`,`X`,`T`,`L`,`W`,`R`,`G`,`E`,`F`,`G`,`K`],[s0,s1])
