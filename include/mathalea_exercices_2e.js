        ...
        for (let i = 0, a, b, c, d, e, texte, texte_corr, cpt = 0; i < this.nb_questions && cpt < 50;) {
            ...
            switch (type_de_questions) {
                ...
                case 1:
                    ...
                    texte_corr = `$\\left(${a} \\sqrt{${b}}\\right)^{2}=${a}^{2}\\times \\left(\\sqrt{${b}}\\right)^{2}=${d}\\times ${b}=${c}$`;
                ...
                case 2:
                    ...
                    texte_corr = `$ ${c} \\sqrt{${b}}\\times ${ecriture_parenthese_si_negatif(d)} \\sqrt{${b}}$<br>
                        $=${c}\\times ${ecriture_parenthese_si_negatif(d)} \\sqrt{${b}} \\times \\sqrt{${b}}$<br>
                        $=${e}\\times ${b}$<br>
                        $=${e * b}$`;
                ...
                case 3:
                    ...
                    texte_corr = `$${a} \\sqrt{${b}}\\left( ${c}  ${ecriture_algebrique(d)}\\sqrt{${b}}\\right)$<br>
                        $=${a} \\sqrt{${b}}\\times ${ecriture_parenthese_si_negatif(c)}${ecriture_algebrique(a)} \\sqrt{${b}}\\times ${ecriture_parenthese_si_negatif(d)}\\sqrt{${b}}$
                        $=${a * c}\\sqrt{${b}}${ecriture_algebrique(a)}\\times ${ecriture_parenthese_si_negatif(d)}*${b}$<br>
                        $=${a * c}\\sqrt{${b}}${ecriture_algebrique(a * d * b)}$`;
                ...
                case 7:
                    ...
                    texte_corr = `$ \\sqrt{${d}}\\times \\sqrt{${c}}$<br>
                        $=\\sqrt{${d}\\times${c}}$<br>
                        $=\\sqrt{${b}\\times${c}\\times${c}}$<br>
                        $=${c}\\sqrt{${b}}$ `;
