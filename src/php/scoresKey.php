...
if ($contentType === "application/json") {
  ...
  // if ($isVerifResult) {
  //   // Il faudra factoriser pour vérifier les variables suiavntes
  //   $prof1 = $decoded->userId[0];
  //   $prof2 = $decoded->userId[1];
  //   $prof3 = $decoded->userId[2];
  //   $classe1 = $decoded->userId[3];
  //   $classe2 = $decoded->userId[4];
  //   $eleve1 = $decoded->userId[5];
  //   $eleve2 = $decoded->userId[6];
  //   $url = "pas d'url pour les verifsResult";
  //   $errors .= "errors verifResult";
