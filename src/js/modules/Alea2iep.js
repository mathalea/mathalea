 ...
 */
  ...
  this.paralleleAuCompasAvecDescription = function (A, B, C, description = true) {
    ...
    if (description) this.textePosition('3. Prenos ensuite avec le compas l\'écartements correspondant à la longueur AC.', -9, 7.9, { couleur: 'green', taille: 2, tempo: 10 })
    ...
    this.compasMasquer()
    if (description) this.textePosition('5. Notons D, le point d\'intersection des deux arcs de cercles.', -9, 6.5, { couleur: 'green', taille: 2, tempo: 10 })
    this.pointCreer(D)
