import { add, equal, Fraction, gcd, larger, largerEq, lcm, max, min, multiply, pow, round, smaller, subtract } from 'mathjs'
import { arc } from './2d/arc.js'
import { cercle } from './2d/cercle.js'
import { point } from './2d/point.js'
import { carre } from './2d/polygone.js'
import { segment } from './2d/segment.js'
import { texteParPosition } from './2d/textes.js'
import { rotation, translation } from './2d/transformations.js'
import { vecteur } from './2d/vecteur.js'
import { colorToLatexOrHTML } from './2dGeneralites.js'
import { fraction } from './fractions.js'
import { fractionSimplifiee } from './outils/arrayFractions.js'
import { egal } from './outils/comparateurs.js'
import { miseEnEvidence } from './outils/contextSensitif.js'
import { nombreDeChiffresDansLaPartieDecimale } from './outils/decimales.js'
import { ecritureParentheseSiNegatif, signeMoinsEnEvidence } from './outils/ecritures.js'
import { listeDiviseurs, pgcd, quotientier } from './outils/entiers.js'
import { extraireRacineCarree, obtenirListeFacteursPremiers } from './outils/factorisation.js'
import { abs, arrondi } from './outils/nombres.js'
import { calcul, texNombre } from './outils/texNombres.js'
