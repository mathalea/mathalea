...
import { listeDiviseurs, pgcd, quotientier } from '../../modules/outils/entiers.js'
...
import { min, max, multiply, subtract, pow, round, Fraction, gcd, add, equal, largerEq, larger, smaller, lcm } from 'mathjs'
...
import { signeMoinsEnEvidence } from './outils/ecritures.js'
