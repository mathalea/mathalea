...
export default function initialiseEditeur () {
  ...
  window.courbe3 = courbe3
  window.courbeInterpolee = courbeInterpolee
  window.courbeInterpolee2 = courbeInterpolee2
