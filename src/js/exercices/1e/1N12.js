...
export default class SommeSuiteArithmetique extends Exercice {
  ...
  nouvelleVersion () {
    ...
    this.question = `Soit $${u}$ la suite arithmétique de premier terme $u_0 = ${u0}$ et de raison $${r}$.`
    this.question += `<br>Calculer $S = ${u}_0 + ${u}_1 + ... + ${u}_{${n}} = \\displaystyle{\\Sigma_{k=0}^{k=${n}}${u}_k}$.`
