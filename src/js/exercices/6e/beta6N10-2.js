...
import { listeQuestionsToContenu, randint, choice, combinaisonListes, texNombrec, calcul } from '../../modules/outils.js'
...
export default function DecompositionNombreDecimal () {
  ...
  this.nouvelleVersion = function () {
    ...
    for (
      ...
      if (i % typesDeQuestionsDisponibles.length === 0) {
        m = randint(1, 9) // le nombre sera le même pour tout l'exercice
        c = randint(0, 9, [m])
        d = randint(0, 9, [m, c])
        u = randint(0, 9, [m, c, d])
      ...
      switch (listeTypeDeQuestions[i]) {
        case 1:
          texte = `La partie entière du nombre $${n}$ est : ` + ajouteChampTexteMathLive(this, i)
          texteCorr =
          ...
          break
        case 2:
          texte = `La partie décimale du nombre $${n}$ est : ` + ajouteChampTexteMathLive(this, i)
          texteCorr =
          ...
          break
        case 3:
          texte = `Le chiffre des dizaines du nombre $${n}$ est : ` + ajouteChampTexteMathLive(this, i)
          texteCorr = texte + `$${d}$`
          setReponse(this, i, d)
          ...
          break
        case 4:
          texte = `Le chiffre des centaines du nombre $${n}$ est : ` + ajouteChampTexteMathLive(this, i)
          texteCorr = texte + `$${c}$`
          setReponse(this, i, c)
          this.autoCorrection[i].reponse.param.digits = 1
          this.autoCorrection[i].reponse.param.decimals = 0
          break
        case 5:
          texte = `Le chiffre des miliers du nombre $${n}$ est : ` + ajouteChampTexteMathLive(this, i)
          texteCorr = texte + `$${m}$`
          setReponse(this, i, m)
          this.autoCorrection[i].reponse.param.digits = 1
          this.autoCorrection[i].reponse.param.decimals = 0
          break
        case 6:
          texte = `Le chiffre des dixièmes du nombre $${n}$ est : ` + ajouteChampTexteMathLive(this, i)
          texteCorr = texte + `$${di}$`
          ...
          break
        case 7:
          texte = `Le chiffre des centièmes du nombre $${n}$ est : ` + ajouteChampTexteMathLive(this, i)
          texteCorr = texte + `$${ci}$`
          ...
          break
        case 8:
          texte = `Le chiffre des millièmes du nombre $${n}$ est : ` + ajouteChampTexteMathLive(this, i)
          texteCorr = texte + `$${mi}$`
          ...
          break
        case 9:
          texte = `Le nombre de dizaines du nombre $${n}$ est : ` + ajouteChampTexteMathLive(this, i)
          ...
          break
        case 10:
          texte = `Le nombre de centaines du nombre $${n}$ est : ` + ajouteChampTexteMathLive(this, i)
          ...
          break
        case 11:
          texte = `Le nombre de dixièmes du nombre $${n}$ est : ` + ajouteChampTexteMathLive(this, i)
          texteCorr =
            texte +
          ...
          break
        case 12:
          texte = `Le nombre de centièmes du nombre $${n}$ est : ` + ajouteChampTexteMathLive(this, i)
          texteCorr =
            texte +
            `$${texNombrec(
  ...
  this.besoinFormulaireNumerique = ['Niveau de difficulté', 3, "1 : Avec seulement des 'chiffres des...'\n 2 : Avec seulement des 'nombres de...'\n3 : Mélange"]
}
