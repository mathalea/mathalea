...
import {listeQuestionsToContenu,randint,texNombrec2,miseEnEvidence,texteEnCouleur_et_gras} from '../../modules/outils.js'
...
export default function Exercice_labyrinthe_numeration() {
  ...
  this.nouvelleVersion = function () {
    ...
    chiffre=randint(0,9)
    texte = `${texteEnCouleur_et_gras(`Trouve la sortie en ne passant que par les cases contenant un nombre dont le chiffre des ${positions[rang]} est un `,'black')}$${miseEnEvidence(chiffre,'black')}$.<br>`
