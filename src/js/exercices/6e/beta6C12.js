...
export default function Questions6C12 () {
      ...
      for (let kk = 0; kk < QuestionsDisponibles.length; kk++) {
        ...
        switch (QuestionsDisponibles[kk]) {
          ...
          case 5:
            ...
            correctionAMC += `Si ${quidame} et son ${Personnage1} achetaient ${NbArticles2 + NbArticles3} ${ArticlePluriel} à ${texNombre3(PrixUnitaire)}${sp()}€ l'unité, `
            correctionAMC += 'le prix final serait de ' + texteEnCouleurEtGras(`${texNombre3(reponseAMC)}`) + `${sp()}€.<br><br>`
            break
          case 6:
