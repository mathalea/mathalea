...
export default function CalculDeVolumes () {
  ...
  this.nouvelleVersion = function (numeroExercice) {
    ...
    const listeUnites = [
      [sp(2) + '\\text{m}', sp(2) + '\\text{m}^3', 'm^3', 'm', 'm\\up{3}'],
      [sp(2) + '\\text{dm}', sp(2) + '\\text{dm}^3', 'dm^3', 'dm', 'dm\\up{3}'],
      [sp(2) + '\\text{cm}', sp(2) + '\\text{cm}^3', 'cm^3', 'cm', 'cm\\up{3}'],
      [sp(2) + '\\text{mm}', sp(2) + '\\text{mm}^3', 'mm^3', 'mm', 'mm\\up{3}']
    ]
    ...
    for (let i = 0, texte, texteCorr, L, l, h, c, r, j, resultat, resultat2, resultat3, resultat4, volume, cpt = 0; i < this.nbQuestions && cpt < 50;) {
      ...
      switch (listeTypeDeQuestions[i]) {
        case 1: // cube
          ...
          texte += context.isAmc ? ` en ${listeUnites[j][4]}` : ''
          texte += this.sup2 ? ', arrondi à l\'unité,' : ''
          texte += ` d'un cube de $${texNombre(c, 1)} $ ${context.isAmc ? listeUnites[j][3] : listeUnites[j][0]} d'arête.`
        ...
        case 2: // pavé droit
          if (this.sup === 1) { // sans conversion
            ...
            texte += context.isAmc ? ` en ${listeUnites[j][4]}` : ''
            texte += this.sup2 ? ', arrondi à l\'unité,' : ''
            texte += ` d'un pavé droit de $${texNombre(l, 1)}$ ${context.isAmc ? listeUnites[j][3] : listeUnites[j][0]} de largeur, de $${texNombre(L, 1)}$ ${context.isAmc ? listeUnites[j][3] : listeUnites[j][0]} de longueur et de $${texNombre(h)}$ ${context.isAmc ? listeUnites[j][3] : listeUnites[j][0]} de hauteur.`
            ...
            volume = l.mul(L).mul(h)
            texte += context.isAmc ? ` en ${listeUnites[j][4]}` : ''
            texte += `, arrondi à l'unité, d'un pavé droit de $${texNombre(l, 1)}$ ${context.isAmc ? listeUnites[j][3] : listeUnites[j][0]} de largeur, de $${texNombre(L, 1)}${listeUnites[j - 1][0]}$ de longueur et de $${texNombre(h)}${listeUnites[j + 1][0]}$ de hauteur.`
        ...
        case 3: // Cylindre
          if (this.sup === 1) {
            ...
            texte += context.isAmc ? ` en ${listeUnites[j][4]}` : ''
            texte += `, arrondi à l'unité, d'un cylindre de $${r}$ ${context.isAmc ? listeUnites[j][3] : listeUnites[j][0]} de rayon et de $${texNombre(h, 0)}$ ${context.isAmc ? listeUnites[j][3] : listeUnites[j][0]} de hauteur.`
            ...
            volume = r.pow(2).mul(h).mul(Decimal.acos(-1))
            texte += context.isAmc ? ` en ${listeUnites[j][4]}` : ''
            texte += `, arrondi à l'unité, d'un cylindre de $${r}$ ${context.isAmc ? listeUnites[j][3] : listeUnites[j][0]} de rayon et de $${texNombre(h.div(10), 1)}${listeUnites[j - 1][0]}$ de hauteur.`
        ...
        case 4: // prisme droit
          if (this.sup === 1) {
            ...
            texte += context.isAmc ? ` en ${listeUnites[j][4]}` : ''
            texte += this.sup2 ? ', arrondi à l\'unité,' : ''
            texte += ` d'un prisme droit de hauteur $${l}$ ${context.isAmc ? listeUnites[j][3] : listeUnites[j][0]} et dont les bases sont des triangles de base $${texNombre(c, 1)}$ ${context.isAmc ? listeUnites[j][3] : listeUnites[j][0]} et de hauteur correspondante $${h}$ ${context.isAmc ? listeUnites[j][3] : listeUnites[j][0]}.`
            ...
            texte += context.isAmc ? ` en ${listeUnites[j][4]}` : ''
            texte += `, arrondi à l'unité, d'un prisme droit de hauteur $${texNombre(l, 1)}${listeUnites[j - 1][0]}$ et dont les bases sont des triangles de base $${texNombre(c, 1)}$ ${context.isAmc ? listeUnites[j][3] : listeUnites[j][0]} et de hauteur correspondante $${h}${listeUnites[j + 1][0]}$.`
        ...
        case 5: // cone
          if (this.sup === 1) {
            ...
            texte += `d'un cône de $${r}$ ${context.isAmc ? listeUnites[j][3] : listeUnites[j][0]} de rayon et de $${h}$ ${context.isAmc ? listeUnites[j][3] : listeUnites[j][0]} de hauteur.`
            ...
            volume = new Decimal(r * r * h).mul(Decimal.acos(-1)).div(3)
            texte += context.isAmc ? ` en ${listeUnites[j][4]}` : ''
            texte += `, arrondi à l'unité, d'un cône de $${r}$ ${context.isAmc ? listeUnites[j][3] : listeUnites[j][0]} de rayon et de $${texNombre(h / 10, 1)}${listeUnites[j - 1][0]}$ de hauteur.`
        ...
        case 6: // pyramide
          if (this.sup === 1) {
            ...
            texte += context.isAmc ? ` en ${listeUnites[j][4]}` : ''
            texte += this.sup2 ? ', arrondi à l\'unité,' : ''
            texte += ` d'une pyramide de hauteur $${h}$ ${context.isAmc ? listeUnites[j][3] : listeUnites[j][0]} et dont la base  est un carré de $${texNombre(c, 1)}$ ${context.isAmc ? listeUnites[j][3] : listeUnites[j][0]} de côté.`
            ...
            volume = c.mul(c).mul(h).div(3)
            texte += context.isAmc ? ` en ${listeUnites[j][4]}` : ''
            texte += `, arrondi à l'unité, d'une pyramide de hauteur $${texNombre(h / 10, 1)}${listeUnites[j - 1][0]}$ et dont la base  est un carré de $${texNombre(c, 1)}$ ${context.isAmc ? listeUnites[j][3] : listeUnites[j][0]}  de côté.`
        ...
        case 7: // boule
          ...
          texte += context.isAmc ? ` en ${listeUnites[j][4]}` : ''
          texte += `, arrondi à l'unité, d'une boule de $${r}$ ${context.isAmc ? listeUnites[j][3] : listeUnites[j][0]} de rayon.`
