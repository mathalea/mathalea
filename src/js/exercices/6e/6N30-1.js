...
import { calcul, choice, html_consigne, lettre_depuis_chiffre, combinaison_listes, liste_de_question_to_contenu, randint } from '../../modules/outils.js'
...
export default function Lire_abscisse_decimale_bis () {
  ...
  this.nouvelle_version = function (numero_de_l_exercice) {
    ...
    if (this.sup == 5) { type_de_questions = combinaison_listes([1, 2, 3], this.nb_questions) } else {
