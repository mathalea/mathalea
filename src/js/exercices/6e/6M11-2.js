    ...
    for (let i = 0, cpt = 0; i < this.nbQuestions && cpt < 50; cpt++) {
      ...
      switch (typesDeQuestionsDisponibles[typesDeQuestions[i] - 1]) {
        ...
        case 'rectangle_triangle_demi_cercle': {
          ...
          texteCorr += `$\\mathcal{P}_{1}=${texNombre(L1)}+${texNombre(L1 + L2)}+${texNombre(l1)}\\times \\pi \\div 2+${texNombre(hyp)}=${texNombrec(troncature(L1 + L1 + hyp + L2 + l1 * Math.PI / 2, 3))}~${texTexte(' cm')}$.<br>`
          texteCorr += `$\\mathcal{A}_{1}=${texNombre(L1)}\\times${texNombre(l1)}+${texNombre(L2)}\\times${texNombre(l1)} \\div 2 + \\pi \\times${texNombre(l1)} \\div 2=${texNombrec(troncature(L1 * l1 + (L2 * l1) / 2 + (l1 / 2) * (l1 / 2) * Math.PI / 2, 3))}~${texTexte(' cm')}^2$.`
          ...
          texteCorr += `<br>Si on utilise $\\pi \\approx 3,14$, alors <br> $\\mathcal{P}_{1}\\approx ${texNombre(L1)}+${texNombre(L1 + L2)}+${texNombre(l1)}\\times 3,14 \\div 2+${texNombre(hyp)}=${texNombrec(troncature(L1 + L1 + hyp + L2 + l1 * 3.14 / 2, 3))}~${texTexte(' cm')}$.<br>`
          texteCorr += `$\\mathcal{A}_{1}\\approx ${texNombre(L1)}\\times${texNombre(l1)}+${texNombre(L2)}\\times${texNombre(l1)} \\div 2 + 3,14 \\times${texNombre(l1)} \\div 2=${texNombrec(troncature(L1 * l1 + (L2 * l1) / 2 + (l1 / 2) * (l1 / 2) * 3.14 / 2, 3))}~${texTexte(' cm')}^2$.`
        ...
        case 'rectangle_demi_cercle': {
          ...
          const zoom = randint(5, 9) / (L1 + L2 / 2)
          const A = point(0, 0, 'A')
          ...
          texteCorr += `$\\mathcal{P}_{1}=${texNombre(L1)}+${texNombre(L2)}+${texNombre(L1)}+${texNombre(L2)}\\times \\pi \\div 2 \\approx ${texNombrec(L1 + L2 + L1 + L2 * Math.PI / 2, 3)}~${texTexte(' cm')}$.<br>`
          texteCorr += `$\\mathcal{A}_{1}=${texNombre(L1)}\\times${texNombre(L2)}+${texNombre(L2 / 2)}\\times${texNombre(L2 / 2)}\\times\\pi \\div 2 \\approx ${texNombre(L1 * L2 + (L2 / 2) * (L2 / 2) * Math.PI / 2, 3)}~${texTexte(' cm')}^2$.`
          ...
          texteCorr += `<br>Si on utilise $\\pi \\approx 3,14$, alors <br> $\\mathcal{P}_{1}\\approx ${texNombre(L1)}+${texNombre(L2)}+${texNombre(L2)}+${texNombre(L2)}\\times 3,14 \\div 2 \\approx ${texNombrec(L1 + L2 + L1 + L2 * 3.14 / 2, 3)}~${texTexte(' cm')}$.<br>`
          texteCorr += `$\\mathcal{A}_{1}\\approx ${texNombre(L1)}\\times${texNombre(L2)}+${texNombre(L2 / 2)}\\times${texNombre(L2 / 2)}\\times 3,14 \\div 2 \\approx ${texNombre(L1 * L2 + (L2 / 2) * (L2 / 2) * 3.14 / 2, 3)}~${texTexte(' cm')}^2$.`
        ...
        case 'rectangle_moins_triangle': {
          ...
          texteCorr += `$\\mathcal{P}_{2}=${c}+${c}+${c}+${texNombre(c1)}+${texNombre(c2)}=${texNombrec(3 * c + c1 + c2)}$ cm<br>`
          texteCorr += `$\\mathcal{A}_{2}=${c}\\times${texNombre(c)}-${texNombre(c1)}\\times${texNombre(c2)}\\div2=${texNombrec(c ** 2 - (c1 * c2) / 2)}${texTexte(' cm')}^2$.`
          texteCorr += '<br>'
          perimetre = 3 * c + c1 + c2
          aire = c ** 2 - (c1 * c2) / 2
          break
        ...
        case 'rectangle_moins_deux_triangles': {
          ...
          texteCorr += `$\\mathcal{P}_{2}=${c}+${c}+${c}+${texNombre(c1)}+${texNombre(c2)}=${texNombrec(3 * c + c1 + c2)}$ cm<br>`
          texteCorr += `$\\mathcal{A}_{2}=${c}\\times${texNombre(c)}-${texNombre(c)}\\times${h}\\div2=${c * c}-${texNombrec((c * h) / 2)}=${texNombrec(c ** 2 - (c * h) / 2)}~${texTexte(' cm')}^2$.`
          texteCorr += '<br>'
          perimetre = 3 * c + c1 + c2
          aire = c ** 2 - (c * h) / 2
          break
