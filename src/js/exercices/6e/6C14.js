      ...
      for (let kk = 0; kk < QuestionsDisponibles.length; kk++) {
        switch (QuestionsDisponibles[kk]) {
          ...
          case 6:
            ...
            break
          case 7 :
            texte += numAlpha(kk) + `Si ${quidame} décidait d'acheter cet article à ${PrixUnitaire}${sp()}€ avec 9 amis, quelle somme équitable minimale devraient-ils, chacun, payer${sp()}?<br><br>`
            texteCorr += numAlpha(kk)
            texteCorr += '$1 + 9 = 10$<br>'
            ...
            if (this.sup3) {
              ...
              texteCorr += `Si ${quidame} partageait cet article avec 9 amis, chacun paierait au minimum ${texNombre3(arrondi(PrixUnitaire / 10, 3))}${sp()}€.<br><br>`
            } else {
              ...
              texteCorr += `Si ${quidame} partageait cet article avec ${Nbpartage} camarades, chacun paierait au minimum ${texNombre3(troncature(arrondi(PrixUnitaire / (Nbpartage + 1), 3) + 0.01, 2))}${sp()}€.<br><br>`
            } break
          case 8 :
            texte += numAlpha(kk) + `Si ${quidame} décidait d'acheter cet article à ${PrixUnitaire}${sp()}€ avec ${Nbpartage} camarades, quelle somme équitable minimale devraient-ils, chacun, payer${sp()}?<br><br>`
            texteCorr += numAlpha(kk)
            ...
            if (estentier(arrondi(PrixUnitaire * 100, 0) / (Nbpartage + 1))) {
              ...
              texteCorr += `Si ${quidame} partageait cet article avec ${Nbpartage} camarades, chacun paierait au minimum ${texNombre3(arrondi(PrixUnitaire / (Nbpartage + 1), 3))}${sp()}€.<br><br>`
            } else {
              texteCorr += `$${PrixUnitaire} \\div ${Nbpartage + 1} \\approx ${texNombre3(arrondi(PrixUnitaire / (Nbpartage + 1), 3))}$ et $${texNombre3(troncature(arrondi(PrixUnitaire / (Nbpartage + 1), 3), 2))} < ${texNombre(arrondi(PrixUnitaire / (Nbpartage + 1), 3))} < ${texNombre(troncature(arrondi(PrixUnitaire / (Nbpartage + 1), 3) + 0.01, 2))}$<br>`
              texteCorr += `Si ${quidame} partageait cet article avec ${Nbpartage} camarades, chacun paierait au minimum ${texNombre3(troncature(arrondi(PrixUnitaire / (Nbpartage + 1), 3) + 0.01, 2))}${sp()}€.<br><br>`
            }
