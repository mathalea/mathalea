...
export default function CalculedddrUnAngle () {
  ...
  this.nouvelleVersion = function () {
    ...
    for (let i = 0, texte, texteCorr, paramsEnonce; i < this.nbQuestions; i++) {
      ...
      const p13a = arc(C, A, 45, false, '#f15929', '#f15929', 0.2)
      const p13b = arc(C, A, -217, false, '#f15929', '#f15929', 0.2)
      ...
      // const p19 = constructionBissectrice(B, C, D, true, 'blue', 'x', 2, 'red', 2)
      // const p19 = constructionBissectrice(B, C, D, false, 'blue', 'x', '1')
      // const p19 = traceCompas(B, C)
      ...
      // objetsEnonce.push(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11)
      objetsEnonce.push(p23.representant(A, '#f15929'), p24, p13a, p13b)
      // objetsEnonce.push(p24, p13a, p13b)
      // objetsEnonce.push(p13a)
      // objetsEnonce.push(p5, segment(A, C, 'black', '->'))
      texte += 'essai'
      paramsEnonce = { xmin: -10, ymin: -10, xmax: 10, ymax: 10, pixelsParCm: 20, scale: 1, mainlevee: false, amplitude: 0.3 }
      texte += '<br>' + mathalea2d(paramsEnonce, objetsEnonce)
      paramsEnonce = { xmin: -10, ymin: -10, xmax: 10, ymax: 10, pixelsParCm: 20, scale: 1, mainlevee: true, amplitude: 0.3 }
      texte += '<br>' + mathalea2d(paramsEnonce, objetsEnonce)
