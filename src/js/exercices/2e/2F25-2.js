...
import { context, math } from '../../modules/context.js'
...
export default function EtudierPariteFonction () {
  ...
  this.nouvelleVersion = function () {
    ...
    for (let i = 0, texte, texteCorr, cpt = 0, a, b, c, d, e, k, i1, i2, i3 = [], typesDeQuestions; i < this.nbQuestions && cpt < 50;) {
      ...
      switch (typesDeQuestions) {
        ...
        case 2:// Cas f(x)=ax^2+bx+c
          ...
          texte += '<br><b>a.</b> Déterminer, en expliquant, si la fonction $f$ est paire, impaire, ou ni l\'un, ni l\'autre. <br>'
        ...
        case 4:// Cas f(x)=ax^2+c sur I non-symétrique
          ...
          if (i2 > i1) { texteCorr += `Par exemple, si $x=${-i2} \\in D$, alors $-x=${i2} \\notin D$.<br>` } else { texteCorr += `Par exemple, si $x=${i1} \\in D$, alors $-x=${-i1} \\notin D$.<br>` }
