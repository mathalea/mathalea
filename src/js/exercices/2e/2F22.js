...
import { listeQuestionsToContenu, combinaisonListes, randint, reduireAxPlusB, choice, ecritureAlgebrique } from '../../modules/outils.js'
...
export default function representerfonctionaffine () {
  ...
  this.nouvelleVersion = function () {
    ...
    for (let i = 0, A, B, a, b, r, f, c, t, l, xA, yA, texte, texteCorr, cpt = 0, typesDeQuestions;
      ...
      switch (typesDeQuestions) {
        case 1:
          ...
          texteCorr += `On lit ici que le point de coordonnées $(0;${b}) \\in \\mathcal{C_f}$.<br>`
          texteCorr += `On peut alors conclure que l'ordonnée à l'origine est : $b=${b}$. <br>`
          texteCorr += 'On sait que pour lire graphiquement le coefficient directeur $a$ d\'une droite, on peut calculer :'
          texteCorr += '<br>$a=\\dfrac{\\text{déplacement vetical}}{\\text{déplacement horizontal}}$.'
          texteCorr += '<br>On peut lire ici le coefficient directeur de la droite, en lisant le déplacement vertical correspondant à un déplacement horizontal d\'une unité .<br>'
        ...
        case 2:
          ...
          texteCorr += `On lit donc ici que $b=${b}$, donc que le point de coordonnées $(0;${b}) \\in \\mathcal{C_f}$.<br>`
          ...
          texteCorr += `Le point de coordonnées $(${xA};${yA}) \\in \\mathcal{C_f}$.<br>`
          texteCorr += mathalea2d({
            xmin: -6,
            ymin: -10,
            xmax: 6,
