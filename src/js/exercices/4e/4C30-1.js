  ...
  this.nouvelleVersion = function () {
    ...
    for (
      ...
      for (let i = 0; i < 6; i++) {
        ...
        entPos.push({
          val: `${texNombre(calcul(signe * randint(10 ** i + 1, 10 ** (i + 1))))}`,
          puissance_inf: signe === 1 ? `10^{${i}}` : `-10^{${i + 1}}`,
          puissance_sup: signe === 1 ? `10^{${i + 1}}` : `-10^{${i}}`,
          puissance_inf_num: signe === 1 ? `${texNombre(calcul(10 ** i))}` : `$${texNombre(calcul(-1 * 10 ** (i + 1)))}`,
          puissance_sup_num: signe === 1 ? `${texNombre(calcul(10 ** (i + 1)))}` : `$${texNombre(calcul(-1 * 10 ** i))}`
        })
        nombreEntier.push(calcul(signe * randint(10 ** i + 1, 10 ** (i + 1))))
      }
      ...
      for (let i = 0; i < 4; i++) {
        decPos.push({
          val: `${texNombre(calcul(signe * randint(10000, 100000) / 10 ** (4 - i)))}`,
          puissance_inf: signe === 1 ? `10^{${i}}` : `-10^{${i + 1}}`,
          puissance_sup: signe === 1 ? `10^{${i + 1}}` : `-10^{${i}}`,
          puissance_inf_num: signe === 1 ? `${texNombre(calcul(10 ** i))}` : `${texNombre(calcul(-1 * 10 ** (i + 1)))}`,
          puissance_sup_num: signe === 1 ? `${texNombre(calcul(10 ** (i + 1)))}` : `${texNombre(calcul(-1 * 10 ** i))}`
        })
        nombreDecimal.push(calcul(signe * randint(10000, 100000) / 10 ** (4 - i)))
      }
      // nombre décimal positif inférieur à 1, entre 0,1 et 1 puis entre 0,01 et 0,1 puis 0,001 et 0,0001
      const decPosInfUn = []
      for (let i = 0; i < 4; i++) {
        decPosInfUn.push({
          val: `${texNombre(calcul(randint(signe * 10 ** (4 - i - 1) + 1, 10 ** (4 - i)) / 10000))}`,
      ...
      switch (listeTypeDeQuestions[i]) {
        case 1: // nombre enier positif
          texte = ajouteChampTexteMathLive(this, 2 * i, 'largeur10 inline', { texteApres: ' < ' + sp(3) }) + `$${entPos[0].val}$` + ajouteChampTexteMathLive(this, 2 * i + 1, 'largeur10 inline', { texte: sp(3) + ' < ' })
          setReponse(this, 2 * i, entPos[0].puissance_inf)
          setReponse(this, 2 * i + 1, entPos[0].puissance_sup)
        ...
        case 2: // nombre enier positif
          texte = ajouteChampTexteMathLive(this, 2 * i, 'largeur10 inline', { texteApres: ' < ' }) + `$${entPos[1].val}$` + ajouteChampTexteMathLive(this, 2 * i + 1, 'largeur10 inline', { texte: ' < ' })
          setReponse(this, 2 * i, entPos[1].puissance_inf)
          setReponse(this, 2 * i + 1, entPos[1].puissance_sup)
        ...
        case 3: // nombre enier positif
          texte = ajouteChampTexteMathLive(this, 2 * i, 'largeur10 inline', { texteApres: ' < ' }) + `$${entPos[2].val}$` + ajouteChampTexteMathLive(this, 2 * i + 1, 'largeur10 inline', { texte: ' < ' })
          setReponse(this, 2 * i, entPos[2].puissance_inf)
          setReponse(this, 2 * i + 1, entPos[2].puissance_sup)
        ...
        case 4: // nombre enier positif
          texte = ajouteChampTexteMathLive(this, 2 * i, 'largeur10 inline', { texteApres: ' < ' }) + `$${entPos[3].val}$` + ajouteChampTexteMathLive(this, 2 * i + 1, 'largeur10 inline', { texte: ' < ' })
          setReponse(this, 2 * i, entPos[3].puissance_inf)
          setReponse(this, 2 * i + 1, entPos[3].puissance_sup)
        ...
        case 5: // nombre enier positif
          texte = ajouteChampTexteMathLive(this, 2 * i, 'largeur10 inline', { texteApres: ' < ' }) + `$${entPos[4].val}$` + ajouteChampTexteMathLive(this, 2 * i + 1, 'largeur10 inline', { texte: ' < ' })
          setReponse(this, 2 * i, entPos[4].puissance_inf)
          setReponse(this, 2 * i + 1, entPos[4].puissance_sup)
        ...
        case 6: // nombre enier positif
          texte = ajouteChampTexteMathLive(this, 2 * i, 'largeur10 inline', { texteApres: ' < ' }) + `$${entPos[5].val}$` + ajouteChampTexteMathLive(this, 2 * i + 1, 'largeur10 inline', { texte: ' < ' })
          setReponse(this, 2 * i, entPos[5].puissance_inf)
          setReponse(this, 2 * i + 1, entPos[5].puissance_sup)
        ...
        case 7: // nombre décimal positif
          texte = ajouteChampTexteMathLive(this, 2 * i, 'largeur10 inline', { texteApres: ' < ' }) + `$${decPos[0].val}$` + ajouteChampTexteMathLive(this, 2 * i + 1, 'largeur10 inline', { texte: ' < ' })
          setReponse(this, 2 * i, decPos[0].puissance_inf)
          setReponse(this, 2 * i + 1, decPos[0].puissance_sup)
        ...
        case 8: // nombre décimal positif
          texte = ajouteChampTexteMathLive(this, 2 * i, 'largeur10 inline', { texteApres: ' < ' }) + `$${decPos[1].val}$` + ajouteChampTexteMathLive(this, 2 * i + 1, 'largeur10 inline', { texte: ' < ' })
          setReponse(this, 2 * i, decPos[1].puissance_inf)
          setReponse(this, 2 * i + 1, decPos[1].puissance_sup)
        ...
        case 9: // nombre décimal positif
          texte = ajouteChampTexteMathLive(this, 2 * i, 'largeur10 inline', { texteApres: ' < ' }) + `$${decPos[2].val}$` + ajouteChampTexteMathLive(this, 2 * i + 1, 'largeur10 inline', { texte: ' < ' })
          setReponse(this, 2 * i, decPos[2].puissance_inf)
          setReponse(this, 2 * i + 1, decPos[2].puissance_sup)
        ...
        case 10: // nombre décimal positif
          texte = ajouteChampTexteMathLive(this, 2 * i, 'largeur10 inline', { texteApres: ' < ' }) + `$${decPos[3].val}$` + ajouteChampTexteMathLive(this, 2 * i + 1, 'largeur10 inline', { texte: ' < ' })
          setReponse(this, 2 * i, decPos[3].puissance_inf)
          setReponse(this, 2 * i + 1, decPos[3].puissance_sup)
        ...
        case 11: // nombre décimal positif inferieur à 1
          texte = ajouteChampTexteMathLive(this, 2 * i, 'largeur10 inline', { texteApres: ' < ' }) + `$${decPosInfUn[0].val}$` + ajouteChampTexteMathLive(this, 2 * i + 1, 'largeur10 inline', { texte: ' < ' })
          setReponse(this, 2 * i, decPosInfUn[0].puissance_inf)
          setReponse(this, 2 * i + 1, decPosInfUn[0].puissance_sup)
        ...
        case 12: // nombre décimal positif inferieur à 1
          texte = ajouteChampTexteMathLive(this, 2 * i, 'largeur10 inline', { texteApres: ' < ' }) + `$${decPosInfUn[1].val}$` + ajouteChampTexteMathLive(this, 2 * i + 1, 'largeur10 inline', { texte: ' < ' })
          setReponse(this, 2 * i, decPosInfUn[1].puissance_inf)
          setReponse(this, 2 * i + 1, decPosInfUn[1].puissance_sup)
        ...
        case 13: // nombre décimal positif inferieur à 1
          texte = ajouteChampTexteMathLive(this, 2 * i, 'largeur10 inline', { texteApres: ' < ' }) + `$${decPosInfUn[2].val}$` + ajouteChampTexteMathLive(this, 2 * i + 1, 'largeur10 inline', { texte: ' < ' })
          setReponse(this, 2 * i, decPosInfUn[2].puissance_inf)
          setReponse(this, 2 * i + 1, decPosInfUn[2].puissance_sup)
        ...
        case 14: // nombre décimal positif inferieur à 1
          texte = ajouteChampTexteMathLive(this, 2 * i, 'largeur10 inline', { texteApres: ' < ' }) + `$${decPosInfUn[3].val}$` + ajouteChampTexteMathLive(this, 2 * i + 1, 'largeur10 inline', { texte: ' < ' })
          setReponse(this, 2 * i, decPosInfUn[3].puissance_inf)
          setReponse(this, 2 * i + 1, decPosInfUn[3].puissance_sup)
