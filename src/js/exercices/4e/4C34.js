  ...
  this.nouvelleVersion = function () {
    ...
    for (
      ...
      if (this.listeQuestions.indexOf(texte) === -1) {
        ...
        this.autoCorrection[i].reponse = { texte: 'résultat', valeur: reponse, param: { digits: Math.max(2, nombreDeChiffresDansLaPartieEntiere(reponse)), decimals: 0, signe: true, exposantNbChiffres: 0 } }
        i++
      }
      cpt++
    }
