    ...
    for (
      ...
      switch (listeTypeDeQuestions[i]) {
        case "losange":
          ...
          texteCorr += `$${nom_quadrilatere}$ est un losange donc ses diagonales se coupent en leur milieu : $${A + O
        ...
        case "rectangle_diagonale_connue":
          ...
          texteCorr += `$${nom_quadrilatere}$ est un rectangle donc il possède 4 angles droits et $${A + B + C
        ...
        case "parallelogramme_est_losange":
          ...
          texteCorr += `Finalement, comme $${nom_quadrilatere}$ est un parallélogramme qui a ses diagonales perpendiculaires alors c'est aussi un losange.`;
          break;
        ...
        case "parallelogramme_n_est_pas_losange":
          ...
          texteCorr += `Si $${nom_quadrilatere}$ était un losange alors ses diagonales devraient être perpendiculaires et $${A + O + B
        ...
        case "parallelogramme_est_rectangle":
          ...
          texteCorr += `Finalement, comme $${nom_quadrilatere}$ est un parallélogramme qui a un angle droit en $${B}$ alors c'est aussi un rectangle.`;
          break;
        ...
        case "parallelogramme_n_est_pas_rectangle":
          ...
          texteCorr += `Finalement, comme $${nom_quadrilatere}$ n'a pas d'angle droit en $${B}$ ce n'est pas un rectangle.`;
          break;
      }
