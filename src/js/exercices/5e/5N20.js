    ...
    for (let i = 0, a, b, c, d, k, s, ordreDesFractions, texte, texteCorr; i < this.nbQuestions;) {
      ...
      if (listeTypeDeQuestions[i] === '+') { // une addition
        ...
        if (context.isHtml && this.interactifType === 'mathLive') {
          if (this.sup3) {
            setReponse(this, i, (new FractionX(a * d + c * b, b * d)).simplifie(), { formatInteractif: 'fraction' })
          } else {
            setReponse(this, i, (new FractionX(a * d + c * b, b * d)).simplifie(), { formatInteractif: 'fractionEgale' })
          }
        }
        ...
        if (context.isHtml && this.interactifType === 'mathLive') {
          if (this.sup3) {
            setReponse(this, i, (new FractionX(Math.abs(a * d - c * b), b * d)).simplifie(), { formatInteractif: 'fraction' })
          } else {
            setReponse(this, i, (new FractionX(Math.abs(a * d - c * b), b * d)).simplifie(), { formatInteractif: 'fractionEgale' })
          }
        }
      }
