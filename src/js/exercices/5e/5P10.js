...
import {listeQuestionsToContenu,randint,choice,shuffle,combinaisonListesSansChangerOrdre,calcul,texNombre,texteEnCouleur_et_gras,tableauColonneLigne} from '../../modules/outils.js'
		...
		for (let i = 0, texte, texteCorr, cpt = 0; i < this.nbQuestions && cpt < 50;) {
			...
			let situations = [
				{//case 0 --> multiplication ligne1 vers ligne2
					...
					isProportionnel: texteEnCouleur_et_gras(`C'est donc un tableau de proportionnalité.`),
					areEgaux: `égaux`,
				...
				{//case 3 --> addition ligne1 vers ligne2
					...
					isProportionnel: texteEnCouleur_et_gras(`Ce n'est donc pas un tableau de proportionnalité.`),
					areEgaux: `différents`,
				},
