...
export default function Placer_points_sur_axe_relatifs () {
  ...
  this.nouvelle_version = function (numero_de_l_exercice) {
    ...
    if (this.sup == 4) { type_de_questions = combinaison_listes([1, 2, 3], this.nb_questions) } else { type_de_questions = combinaison_listes([parseInt(this.sup)], this.nb_questions) }
