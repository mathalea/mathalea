...
import {listeQuestionsToContenuSansNumero,randint,choice,texteEnCouleur_et_gras} from '../../modules/outils.js'
...
export default function Aire_du_parallelogramme() {
	...
	this.nouvelleVersion = function (numeroExercice) {
		...
		let texteCorr = `Dans chaque parallélogramme, le segment en pointillés est ${texteEnCouleur_et_gras("perpendiculaire")} à deux côtés opposés, c'est donc une ${texteEnCouleur_et_gras("hauteur")}.<br>`;
		texteCorr += `Pour obtenir l'aire, il faut multiplier cette ${texteEnCouleur_et_gras("hauteur")} par la longueur de la ${texteEnCouleur_et_gras("base")} correspondante.`;
		texteCorr += "<br><br>";
