...
export default function Tableaux_et_pourcentages () {
  ...
  this.nouvelleVersion = function () {
    ...
    for (let i = 0, texte, texteCorr, cpt = 0; i < this.nbQuestions && cpt < 50;) {
      ...
      let corrections
      if (this.sup3) {
        const interieur_tableau_tableau_corr = choice([
          {
        ...
        const tableau_case_4 = tableauColonneLigne(['\\text{Prix en €}', texPrix(prix[0]), texPrix(prix[0]), texPrix(prix[0]), texPrix(prix[0])], ['\\text{Remise en pourcentage}', '\\text{Montant de la remise en €}', '\\text{Nouveau prix en €}'],
          interieur_tableau_tableau_corr.tableau_case_4
        )
        const tableau_case_4_corr = tableauColonneLigne(['\\text{Prix en €}', texPrix(prix[0]), texPrix(prix[0]), texPrix(prix[0]), texPrix(prix[0])], ['\\text{Remise en pourcentage}', '\\text{Montant de la remise en €}', '\\text{Nouveau prix en €}'],
