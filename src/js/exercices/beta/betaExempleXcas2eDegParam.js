          ...
          if (a2 == 0) { // Eq du 1er degré
            ...
            if (a < 0) {
                ...
                if (a2 > 0) {
                    ...
                    texteCorr += `<br><u>Conclusion</u> : L'équation du départ admet toujours 2 solutions.`                
                } else {
                    texteCorr += `<br>Comme le coefficient devant $m^2$ est négatif, $\\Delta < 0$.` 
                    texteCorr += `<br><u>Conclusion</u> : L'équation du départ n'a pas de solution réelle.`  
                }         
                ...
                if (a2 > 0) {
                    ...
                    texteCorr += `<br><u>Conclusion</u> : Si $m=${xcas(`m1`)}$ l'équation admet une unique solution, sinon l'équation admet 2 solutions.`                
                } else {
                ...
                if (a2 > 0) {
                    ...
                    texteCorr += `<br><u>Conclusion</u> :<br> - Si $m=m_1$ ou $m_2$, l'équation admet une unique solution,`  
