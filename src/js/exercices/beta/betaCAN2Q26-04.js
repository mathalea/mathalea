...
import { randint, prenom, choice, texteEnCouleur, calcul } from '../../modules/outils.js'
export const titre = 'Proportionnalité et notes'
  ...
  this.nouvelleVersion = function () {
    ...
    if (a === 40) {
      ...
      this.question = `${prenom()} a obtenu $${n}$ sur $40$ à son devoir.<br>
        Quelle est sa note sur $20$ ?`
      this.correction = `Sa note est de $${(n / 2)}$ sur $20$.`
      this.correction += texteEnCouleur(`<br> Mentalement : <br>
    ...
    if (a === 50) {
      ...
      this.question = `${prenom()} a obtenu $${n}$ sur $50$ à son devoir.<br>
        Quelle est sa note sur $20$ ?`
      this.correction = `Sa note est de $${(n * 2) / 5}$ sur $20$.`
      this.correction += texteEnCouleur(`<br> Mentalement : <br>
    ...
    if (a === 60) {
      ...
      this.question = `${prenom()} a obtenu $${n}$ sur $60$ à son devoir.<br>
        Quelle est sa note sur $20$ ?`
      this.correction = `Sa note est de $${(n / 3)}$ sur $20$.`
      this.correction += texteEnCouleur(`<br> Mentalement : <br>
    ...
    if (a === 80) {
      ...
      this.question = `${prenom()} a obtenu $${n}$ sur $80$ à son devoir.<br>
        Quelle est sa note sur $20$ ?`
      this.correction = `Sa note est de $${(n / 4)}$ sur $20$.`
      this.correction += texteEnCouleur(`<br> Mentalement : <br>
    ...
    if (a === 100) {
      ...
      this.question = `${prenom()} a obtenu $${n}$ sur $100$ à son devoir.<br>
        Quelle est sa note sur $20$ ?`
      this.correction = `Sa note est de $${(n / 5)}$ sur $20$.`
      this.correction += texteEnCouleur(`<br> Mentalement : <br>
