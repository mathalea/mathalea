    ...
    this.nouvelleVersion = function () {
      ...
      for (let i = 0, texte, texteCorr, a, b, c,P,xs,ys,x,y, Psimp,d,x1, x2,x3,f,r,svgYmin,svgYmax,F, cpt = 0;i < this.nbQuestions && cpt < 50;) {
        ...
        switch (listeTypeDeQuestions[i]) {
            ...
            texteCorr = `Comme $a=${a} ${"<>"[1*(a > 0)]} 0$, la parabole $P$ a ses branches dirigées vers le ${["bas","haut"][1*(a > 0)]}`
        ...
        texteCorr += mathalea2d({xmin : xmin, xmax : xmax, ymin : ymin, ymax : ymax, pixelsParCm : 30, scale : .8}, r, cg)
