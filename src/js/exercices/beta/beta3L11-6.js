...
import { listeQuestionsToContenu, choice, combinaisonListes, abs, randint, lettreDepuisChiffre, printlatex, ecritureAlgebriqueSauf1, ecritureAlgebrique, rienSi1 } from '../../modules/outils.js'
    ...
    for (let i = 0, texte, texteCorr, a, b, c, d, e, f, operation, couplenm, k, cpt = 0; i < this.nbQuestions && cpt < 50;) {
      ...
      switch (listeTypeDeQuestions[i]) {
        case 'c(ax+b)+x(ax+b)':
          ...
          texteCorr = texte
          texteCorr += `<br>$\\phantom{AB ${lettreDepuisChiffre(i + 1)}}=(${c}+x)(${rienSi1(a)}x${ecritureAlgebrique(b)})$`
          break
        case 'c(ax+b)-x(ax+b)':
          texte = `$${lettreDepuisChiffre(i + 1)} = ${c}(${rienSi1(a)}x${ecritureAlgebrique(b)})-x(${rienSi1(a)}x${ecritureAlgebrique(b)})$`
          texteCorr = texte
        ...
        case 'x(ax+b)+c(ax+b)':
          ...
          texteCorr = texte
          texteCorr += `<br>$\\phantom{AB ${lettreDepuisChiffre(i + 1)}}=(x+${c})(${rienSi1(a)}x${ecritureAlgebrique(b)})$`
          break
        case 'x(ax+b)-c(ax+b)':
          texte = `$${lettreDepuisChiffre(i + 1)} = x(${rienSi1(a)}x${ecritureAlgebrique(b)})-${c}(${rienSi1(a)}x${ecritureAlgebrique(b)})$`
          texteCorr = texte
        ...
        case '(ax+b)(cx+d)+(ax+b)(ex+f)':
          ...
          texteCorr = texte
          texteCorr += `<br>$\\phantom{AB ${lettreDepuisChiffre(i + 1)}}=(${rienSi1(a)}x${ecritureAlgebrique(b)})(${c + e}x${ecritureAlgebrique(d + f)})$`
          break
        case '(ax+b)(cx+d)-(ax+b)(ex+f)':
          texte = `$${lettreDepuisChiffre(i + 1)}=(${rienSi1(a)}x${ecritureAlgebrique(b)})(${c}x${ecritureAlgebrique(d)})-(${rienSi1(a)}x${ecritureAlgebrique(b)})(${rienSi1(e)}x${ecritureAlgebrique(f)})$`
          texteCorr = texte
          texteCorr += `<br>$\\phantom{AB ${lettreDepuisChiffre(i + 1)}}=(${rienSi1(a)}x${ecritureAlgebrique(b)})(${rienSi1(c - e)}x${ecritureAlgebrique(d - f)})$`
          break
      ...
      case '(ax+b)(cx+d)-(ex+f)(ax+b)':
        ...
        case '(cx+d)(ax+b)+(ex+f)(ax+b)':
            ...
            texteCorr = texte
            texteCorr += `<br>$\\phantom{AB ${lettreDepuisChiffre(i + 1)}}=(${c + e}x${ecritureAlgebrique(d + f)})(${rienSi1(a)}x${ecritureAlgebrique(b)})$`
      break
      case  '(cx+d)(ax+b)-(ex+f)(ax+b)':
        texte = `$${lettreDepuisChiffre(i + 1)}=(${c}x${ecritureAlgebrique(d)})(${rienSi1(a)}x${ecritureAlgebrique(b)})-(${rienSi1(e)}x${ecritureAlgebrique(f)})(${rienSi1(a)}x${ecritureAlgebrique(b)})$`
        texteCorr = texte
        texteCorr += `<br>$\\phantom{AB ${lettreDepuisChiffre(i + 1)}}=(${rienSi1(c - e)}x${ecritureAlgebrique(d - f)})(${rienSi1(a)}x${ecritureAlgebrique(b)})$`
  break
