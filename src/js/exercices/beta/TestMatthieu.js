...
export const titre = 'Ceci est un test'

/** Description de l'exercice / des niveaux 
 * 
 * @author Matthieu Devillers
 * Référence (dans le referentiel Mathalea)
 */
export default function NomDeFonctionTop () {
