...
export const dateDePublication = '11/12/2021' // La date de publication initiale au format 'jj/mm/aaaa' pour affichage temporaire d'un tag
    ...
    if (this.interactif) {
      ...
      this.autoCorrection[0] = {
        ...
        propositions: [
          ...
          {
            texte: 'Tableau avec inversion des signes ',
            statut: false
          }
        ]
      }
