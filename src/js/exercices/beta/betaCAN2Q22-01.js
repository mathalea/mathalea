...
export default function CoordonneesPointDroite () {
  ...
  this.nouvelleVersion = function () {
    ...
    this.question = ` Donner les coordonnées du point de la droite 
    d'équation $y=${reduireAxPlusB(a, b)}$ qui a pour abscisse $${c}$.`
    if (a === 1) {
  ...
  Les coordonnées du  point sont donc : $(${c};${texNombrec(a * c + b)})$.`
    ...
    this.reponse = `(${texNombrec(c)};${texNombrec(a * c + b)})`
  }
}
