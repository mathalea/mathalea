...
import { listeQuestionsToContenu, randint, calcul, choice, texFraction, texNombrec, sp } from '../../../modules/outils.js'
    ...
    for (let i = 0, texte, texteCorr, a, b, c, T, proportion, cpt = 0; i < this.nbQuestions && cpt < 50;) {
      switch (choice([1, 1, 2, 3, 4])) { //
        case 1 :// magazine arithmetico-geo
          ...
          texte = `Chaque année, un magazine perd $${a} ${sp()}\\%$  de ses abonnés mais en gagne $${b}$ nouveaux.<br>
          ...
          texteCorr = `On a $${s}_{n+1}=\\underbrace{${s}_{n}-${texNombrec(a / 100)}${s}_{n}}_{\\text{Perte de } ${a}${sp()} \\%} +${b}=${texNombrec(1 - a / 100)}${s}_{n}+${b}$.<br>
        ...
        case 2 :// magazine geo
          ...
          texteCorr = `On a $${s}_{n+1}=\\underbrace{${s}_{n}-${texNombrec(a / 100)}${s}_{n}}_{\\text{Perte de } ${a}${sp()} \\%} =${texNombrec(1 - a / 100)}${s}_{n}$.<br>
