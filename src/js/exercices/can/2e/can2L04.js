...
import { randint, sp, listeQuestionsToContenuSansNumero, texFractionReduite, rienSi1 } from '../../../modules/outils.js'
import { ajouteChampTexteMathLive, setReponse } from '../../../modules/gestionInteractif.js'
export const titre = 'Coordonnées point d’intersection axe des ordonnées/droite'
...
export default function CoordonneesPointIntersectionAxeOrdonneesDroite () {
  ...
  this.nouvelleVersion = function () {
    ...
    const c = n * b
    if (c > 0) {
      this.listeQuestions = [` Les coordonnées du point d'intersection entre la droite d'équation $${rienSi1(a)}x+${rienSi1(b)}y+${c}=0$ et l'axe des ordonnées sont  : <br><br>
