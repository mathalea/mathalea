...
export default function SujetCAN2022Seconde () {
  ...
  this.nouvelleVersion = function () {
    ...
    const nbQ1 = min(round(this.nbQuestions * 10 / 30), 1) // Choisir d'un nb de questions de niveau 1 parmi les 8 possibles.
    const nbQ2 = min(this.nbQuestions - nbQ1, 1)
    const typeQuestionsDisponiblesNiv1 = shuffle([4]).slice(-nbQ1).sort(compareNombres)
    const typeQuestionsDisponiblesNiv2 = shuffle([4]).slice(-nbQ2).sort(compareNombres)
