...
export default function NombrePairFois5 () {
  ...
  this.nouvelleVersion = function () {
    ...
    $\\bullet$ soit d'abord multiplier par $10$, puis diviser par $2$ :<br>
    $${a}\\times 5 = (${a} \\times 10)\\div 2  = ${calcul(a * 10)}\\div 2=${this.reponse}$.<br>
    $\\bullet$ soit d'abord diviser  par $2$, puis multiplier  par $10$ :<br>
    $${a}\\times 5 = (${a}\\div 2 ) \\times 10 = ${calcul(a / 2)}\\times 10=${this.reponse}$.<br>
      `)
  }
}
