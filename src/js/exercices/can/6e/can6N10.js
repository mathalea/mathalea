    ...
    switch (choice(['a', 'b', 'c', 'd', 'e'])) { //,
      case 'a':
        ...
        if (choice([true, false])) {
          this.question = `Écrire sous forme décimale : $\\dfrac{${b}}{100}+\\dfrac{${a}}{10}+\\dfrac{${c}}{1000}$ `
          ...
          this.question = `Écrire sous forme décimale : $\\dfrac{${c}}{1000}+\\dfrac{${a}}{10}+\\dfrac{${b}}{100}$ `
      ...
      case 'b':
        ...
        if (choice([true, false])) {
          this.question = `Écrire sous forme décimale : $${u}+\\dfrac{${a}}{10}+\\dfrac{${c}}{1000}$ `
          this.correction = `$${u}+\\dfrac{${a}}{10}+\\dfrac{${c}}{1000}=${u}+${texNombrec(a / 10)}+${texNombrec(c / 1000)}=${texNombrec(u + a / 10 + c / 1000)}$`
        } else {
          this.question = `Écrire sous forme décimale : $${u}+\\dfrac{${c}}{1000}+\\dfrac{${a}}{10}$ `
      ...
      case 'c':
        ...
        if (choice([true, false])) {
          this.question = `Écrire sous forme décimale : $${u}+\\dfrac{${b}}{100}+\\dfrac{${c}}{1000}$ `
          this.correction = `$${u}+\\dfrac{${b}}{100}+\\dfrac{${c}}{1000}=${u}+${texNombrec(b / 100)}+${texNombrec(c / 1000)}=${texNombrec(u + b / 100 + c / 1000)}$`
        } else {
          this.question = `Écrire sous forme décimale : $${u}+\\dfrac{${c}}{1000}+\\dfrac{${b}}{100}$ `
      ...
      case 'd':
        ...
        if (choice([true, false])) {
          this.question = `Écrire sous forme décimale : $\\dfrac{${a}}{10}+\\dfrac{${c}}{1000}$ `
          this.correction = `$\\dfrac{${a}}{10}+\\dfrac{${c}}{1000}=${texNombrec(a / 10)}+${texNombrec(c / 1000)}=${texNombrec(a / 10 + c / 1000)}$`
        } else {
          this.question = `Écrire sous forme décimale : $\\dfrac{${c}}{1000}+\\dfrac{${a}}{10}$ `
