...
export default function Perimetre () {
  ...
  this.nouvelleVersion = function () {
    ...
    objets.push(texteParPosition(`$${texNombre(b, 1)}\\text{m}$`, milieu(A, D).x - 0.5, milieu(A, D).y, 'milieu', 'black', 1, 'middle', true),
      texteParPosition(`$${texNombre(a, 1)}\\text{m}$`, milieu(B, C).x + 0.5, milieu(B, C).y, 'milieu', 'black', 1, 'middle', true),
      texteParPosition(`$${texNombre(c, 1)}\\text{m}$`, milieu(A, B).x, milieu(A, B).y - 0.8, 'milieu', 'black', 1, 'middle', true),
      texteParPosition(`$${texNombre(d, 1)}\\text{m}$`, milieu(C, D).x, milieu(C, D).y + 0.5, 'milieu', 'black', 1, 'middle', true))
