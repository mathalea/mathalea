...
export default function ProblemesDeLongueurs () {
  ...
  this.nouvelleVersion = function () {
    ...
    this.question = `Sachant que $FE=${c}$ cm, combien mesure $AB$ ?<br>` + mathalea2d({ xmin: -0.5, ymin: -1, xmax: 16.5, ymax: 3.5, scale: 0.5 }, objets)
    this.reponse = a * b * c
    this.correction = `Commme $AB=${b}\\times DE$ et comme $DE=${a}\\times FE$ alors $AB=${b}\\times${a}\\times ${c} \\text{ cm} =${a * b * c}$ cm`
  }
}
