...
export default function LireHeure () {
  ...
  this.nouvelleVersion = function () {
    ...
    this.question = 'Quelle est l\'heure du matin indiquée par cette horloge ? Au format ...h....<br>' + mathalea2d({ xmin: -3, ymin: -3, xmax: 3, ymax: 3, scale: 1, zoom: this.tailleDiaporama, style: 'margin: auto' }, horloge)
    this.reponse = `${h}h ${m}`
