...
import { liste_de_question_to_contenu, randint, combinaison_listes_sans_changer_ordre, tex_enumerate, mise_en_evidence, itemize, tikz_machine_diag, num_alpha, tex_cadre_par_orange } from '../../modules/outils.js'
...
export default function fonctions_calculs_d_images () {
  ...
  this.nouvelle_version = function (numero_de_l_exercice) {
    ...
    const liste_type_de_questions = combinaison_listes_sans_changer_ordre(type_de_questions_disponibles, this.nb_questions)
