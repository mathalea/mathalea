...
export default function Calculs_trigonometriques () {
  ...
  this.nouvelleVersion = function () {
    ...
    let distance; let hauteur; let alfa; let baita; let beta; let alf; let bait; let alpha; let teta; let taille; let index; let A; let B; let O; let H; let S; let C; let M; let R; let R2; let Axe; let normalV; let normalH; let P; let HP; let Sph; let OP; let PoleNord; let PoleSud; let objets = []; let p
    if (context.isHtml) {
      alfa = 'α'
      baita = 'β'
    } else {
