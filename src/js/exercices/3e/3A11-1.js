...
import {listeQuestionsToContenu,randint,shuffle,combinaisonListesSansChangerOrdre,nombre_avec_espace,texteEnCouleur_et_gras,itemize,modalPdf,modalVideo,cribleEratostheneN,warnMessage} from '../../modules/outils.js'
		...
		for (let i = 0, texte, texteCorr, cpt = 0; i < this.nbQuestions && cpt < 50;) {
			...
			switch (type_de_questions) {
				...
				case 7: // nombre premier inférieur à 529
					...
					texteCorr += texteEnCouleur_et_gras(nombre_avec_espace(Number(N)) + ` n'est donc pas premier.`);
					break;
			};
