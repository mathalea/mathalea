  ...
  this.nouvelleVersion = function () {
    ...
    for (let i = 0, texte, texteCorr,j, cpt = 0; i < this.nbQuestions && cpt < 50;) {
        objets=[]
          ...
          if (this.sup) {
            texteCorr += `${num_alpha(j)}Dans le triangle $BHS$ rectangle en $H$, les angles aigus sont complémentaires donc $\\widehat{BSH}=90-${baita}$.<br>`
            texteCorr += `${num_alpha(j+1)}Dans le triangle $AHS$ rectangle en $H$, pour la même raison $\\widehat{ASH}=90-${alfa}$.<br>`
            j+=2
          }
          texteCorr+=`${num_alpha(j)}On sait que $\\widehat{BSH}=90-${baita}$ et $\\widehat{ASH}=90-${alfa}$.<br>Donc $\\widehat{BSC}=\\widehat{ASH}-\\widehat{BSH}=90-${alfa}-(90-${baita})=\\cancel{90}-${alfa}-\\cancel{90}+${baita}=${baita}-${alfa}$.<br>`
          j++
            texteCorr+=`${num_alpha(j)}Dans le triangle $BCS$ rectangle en $C$, $\\sin(\\widehat{BSC})=\\dfrac{BC}{BS}$ d'où $BS=\\dfrac{BC}{\\sin(\\widehat{BSC})}=\\dfrac{BC}{\\sin(${baita}-${alfa})}$.<br>`
          j++
            texteCorr+=`${num_alpha(j)}Dans le triangle $ABC$ rectangle en $C$, $\\sin(\\widehat{BAC})=\\dfrac{BC}{AB}$ d'où $BC=AB\\times \\sin(\\widehat{BAC})=AB\\times \\sin(${alfa})$.<br>`
          j++

            texteCorr+=`${num_alpha(j)}Dans le triangle $BHS$ rectangle en $H$, $h=BS\\times \\sin(${baita})=\\dfrac{BC}{\\sin(${baita}-${alfa})}\\times \\sin(${baita})=\\dfrac{AB\\times \\sin(${alfa})}{\\sin(${baita}-${alfa})}\\times \\sin(${baita})$<br>`

          j++
          texteCorr += `${num_alpha(j)}Application numérique : $h=\\dfrac{${distance}\\times \\sin(${alpha})}{\\sin(${beta}-${alpha})}\\times \\sin(${beta})$`
