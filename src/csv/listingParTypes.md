...
|:-----:|:-----------------------------------------------:|:-----:|:----------------:|:-----:|:----------:|
|3G21|Contrôler si deux droites sont parallèles|OK|AMCOpen|KO|-|
|3G30|Calculer une longueurs dans un triangle rectangle en utilisant la trigonométrie|OK|AMCOpen NC|KO|-|
|3L11-1|Utiliser la double distributivité|KO|KO|OK|mathLive|
...
|4C21|Additionner ou soustraire deux fractions|OK|AMCOpen double NC|KO|-|
|4C32-1|Calcul avec les puissances de dix|KO|KO|OK| |
|4G20-2|Racine carré d’un carré parfait (calcul mental)|KO|KO|OK| |
|4G20|Calculer une longueur avec le théorème de Pythagore|OK|AMCOpen Num|OK| |
|4G21|Déterminer si un triangle est rectangle ou pas.|KO|KO|OK| |
|4G30|Calculer des longueurs avec la propriété de Thalès|OK|AMCOpen Num|KO|-|
|4G40|Utiliser le cosinus pour calculer une longueur dans un triangle rectangle|OK|AMCOpen NC|KO|-|
...
|5N13-2|Égalités entre fractions simples|OK|qcmMono|KO|-|
|5N13|Simplification de fractions|OK|AMCOpen|KO|-|
...
|6C34|Dernier chiffre d’un calcul|KO|KO|OK| |
...
|6G41|Compléter une représentation en perspective cavalière|OK|AMCOpen|KO|-|
