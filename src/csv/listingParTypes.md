...
|3G30|Calculer une longueurs dans un triangle rectangle en utilisant la trigonométrie|OK|AMCOpen NC|KO|KO|
|3G31|Calculer un angle dans un triangle rectangle en utilisant la trigonométrie|OK|AMCOpen NC|KO|KO|
|3G32-1|Calcul d’un parallèle terrestre|OK|AMCOpen|KO|KO|
|3L11-1|Utiliser la double distributivité|OK|type de question AMC non prévu|OK|mathLive|
...
|4C21|Additionner ou soustraire deux fractions|OK|AMCOpen double NC|KO|KO|
|4C32-1|Calcul avec les puissances de dix|OK|qcmMono|OK| |
|4C32|Notation scientifique|OK|AMCOpen Num|KO|KO|
|4C34|Calculs utilisant les priorités opératoires et les puissances|OK|AMCOpen NC|KO|KO|
|4G20-2|Racine carré d’un carré parfait (calcul mental)|OK|AMCOpen Num|OK| |
|4G20|Calculer une longueur avec le théorème de Pythagore|OK|AMCOpen NC|OK| |
|4G21|Déterminer si un triangle est rectangle ou pas.|OK|qcmMono|OK| |
|4G30|Calculer des longueurs avec la propriété de Thalès|OK|AMCOpen NC|KO|KO|
|4G40|Utiliser le cosinus pour calculer une longueur dans un triangle rectangle|OK|AMCOpen NC|KO|KO|
...
|6C10-4|Addition de deux entiers|OK|AMCOpen Num|OK| |
...
|6C20|Additions et soustractions de nombres décimaux|OK|AMCOpen Num|OK| |
...
|6C30-1|Multiplications d’un nombre décimal par 10, 100 ou 1 000.|OK|AMCOpen Num|OK| |
|6C30-2|Calculer le produit de deux décimaux connaissant le produit de deux entiers|OK|AMCOpen Num|OK| |
...
|6C31|Divisions décimales|OK|AMCOpen Num|OK| |
|6C33|Calculer en utilisant les priorités opératoires|OK|AMCOpen Num|OK| |
|6C34|Dernier chiffre d’un calcul|OK|AMCOpen Num|OK| |
|6G23-1|Mesurer un angle|OK|qcmMono|OK| |
|6G33|Reconnaitre un quadrilatère particulier à partir de ses propriétés|OK|qcmMult|OK| |
...
|6N33-1|Calculer le pourcentage d’un nombre de tête|OK|AMCOpen Num|KO|KO|
