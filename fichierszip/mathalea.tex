%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                ...
                %
                % http://mathalea.mathslozano.fr/mathalea_amc.php?ex=6C10-2,sup=2-3-4-5-6-7-8-9,ModeQCM=true,nb_questions=10&serie=qOtX
                %
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	%\usepackage{hyperref}					% Pour gérer les liens hyper-texte
	 ...
	 \usepackage{setspace}					% Pour egin{spacing}{2.0} end{spacing}
