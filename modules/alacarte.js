...
let code_LaTeX, code_LaTeX_corr, tableau_de_demandes, objet_contenu = [], objet_contenu_correction = [],
    listeDesExercicesDemandes = [], contenu_fichier = '', listeObjetsExercice = {}, message_d_erreur = "";
...
function item_to_contenu(txt) {
    ...
    if (idExerciceMathALEA in listeObjetsExercice) {
        let exercice_aleatoire = listeObjetsExercice[idExerciceMathALEA];
        if (dictionnaire['sup']) {
...
window.onload = function () {
    ...
    $("#valider").click(function () {
        ...
        tableau_de_demandes.forEach(function (ligne, numero_de_ligne) {
            ...
            objet_contenu[numero_de_ligne] = new Array;
            objet_contenu_correction[numero_de_ligne] = new Array;
