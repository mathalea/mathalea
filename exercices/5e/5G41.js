...
export default function Constructions_parallelogrammes_particuliers() {
	...
	this.nouvelle_version = function () {
       ...
       let type_de_question,type_de_questions_disponibles
        ...
        else if (this.sup==2) type_de_questions_disponibles=[4,5,6]
        ...
        switch (type_de_question){
            ...
            case 5:
                ...
                case 6:
                    ...
                    texte_corr+=`Comme ${nom} est un parallélogramme, ses diagonales se coupent en leur milieu $${noms[4]}$.<br>`
                    texte_corr+=`On en déduit que $${noms[0]+noms[4]}=${noms[4]+noms[2]}$ et que $${noms[1]+noms[4]}=${noms[4]+noms[3]}$.<br>`
        ...
        switch (type_de_question){
           ...
           break
            ...
            break
            case 5:
                texte_corr+=mathalea2d({ xmin: xMin, ymin: yMin, xmax: xMax, ymax: yMax, pixelsParCm: 25, scale: 1 }, tri[0],tri[1],demiDroite(A,B),demiDroite(A,D),afficheMesureAngle(B,A,D,'black',1,alpha+'°'),afficheLongueurSegment(A,B),afficheLongueurSegment(A,D))
                objets_enonce.push(cible3,cible2)
                objets_correction.push(p[0],p[1],t3)
            ...
            break
            case 6:
                texte_corr+=mathalea2d({ xmin: xMin, ymin: yMin, xmax: xMax, ymax: yMax, pixelsParCm: 25, scale: 1 }, objets_correction,tri[0],tri[1],afficheLongueurSegment(B,A),afficheLongueurSegment(O,B),afficheLongueurSegment(A,O),t1,t2)
                objets_enonce.push(cible3,cible2)
