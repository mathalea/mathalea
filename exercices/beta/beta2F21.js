            ...
            switch (type_de_questions) {
                case 1:
                    ...
                    case 2:
                        ...
                        l.color='red'
                        texte = `Déterminer, en détaillant les calculs, l'expression algébrique de la fonction affine $f$ représentée ci-dessous,<br>`;
                        texte += `sachant que la droite passe par les points $A(${xA};${yA})$ et $B(${xB};${yB})$<br>`                
                        texte += mathalea2d({
                        xmin: -6,
                        ymin: -10,
                        xmax: 6,
