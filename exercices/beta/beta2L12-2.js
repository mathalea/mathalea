...
export default function Factoriser_Identites_remarquables2() {
    ...
    this.nouvelle_version = function () {
            ...
            switch (type_de_questions) {
                case 1:
                 ...
                 case 2:
                    ...
                    texte_corr += ` $\\iff (\\underline{${reduire_ax_plus_b(a,b)}})( ${reduire_ax_plus_b(c,d)}${ecriture_algebrique(-e)}x${ecriture_algebrique(-f)}))=0$<br>`;                            
                    texte_corr += ` $\\iff (${reduire_ax_plus_b(a,b)})( ${reduire_ax_plus_b(c-e,d-f)})=0$<br>`; 
                    if (c-e==0){ 
                    texte_corr +=`$\\iff ${reduire_ax_plus_b(a,b)}=0$<br>`
                    texte_corr +=`$x=${tex_fraction_signe(-b,a)}$<br>`
             ...
             break;  
                case 3:
                texte = ` ($${reduire_ax_plus_b(a,b)})^{2}+
                ( ${reduire_ax_plus_b(a,b)})( ${reduire_ax_plus_b(e,f)})=0$`; //(ax+b)²+(ax+b)(ex+f)=0
                texte_corr = ` $(${reduire_ax_plus_b(a,b)})^{2}+
                ( ${reduire_ax_plus_b(a,b)})( ${reduire_ax_plus_b(e,f)})=0$<br>`;
                texte_corr += ` $(${reduire_ax_plus_b(a,b)})(${reduire_ax_plus_b(a,b)})+
                ( ${reduire_ax_plus_b(a,b)})( ${reduire_ax_plus_b(e,f)})=0$<br>`;
                texte_corr += ` On observe que $(${reduire_ax_plus_b(a,b)})$ est un facteur commun dans les deux termes :<br>`;  
                texte_corr += ` $\\phantom{\\iff} (\\underline{${reduire_ax_plus_b(a,b)}})(${reduire_ax_plus_b(a,b)})+
                 (\\underline{${reduire_ax_plus_b(a,b)})}( ${reduire_ax_plus_b(e,f)})=0$<br>`;
                texte_corr += ` $\\iff (\\underline{${reduire_ax_plus_b(a,b)}})(( ${reduire_ax_plus_b(a,b)})+
               ( ${reduire_ax_plus_b(e,f)}))=0$<br>`;  
        ...
        case 4:
            texte = ` ($${reduire_ax_plus_b(a,b)})( ${reduire_ax_plus_b(c,d)})-
            ( ${reduire_ax_plus_b(a,b)})^{2}=0$`; //(ax+b)(cx+d)-(ax+b)²=0
            texte_corr = ` ($${reduire_ax_plus_b(a,b)})( ${reduire_ax_plus_b(c,d)})-
            ( ${reduire_ax_plus_b(a,b)})^{2}=0$<br>`;
            texte_corr += ` ($${reduire_ax_plus_b(a,b)})( ${reduire_ax_plus_b(c,d)})-
            ( ${reduire_ax_plus_b(a,b)})( ${reduire_ax_plus_b(a,b)})=0$<br>`;
            texte_corr += ` On observe que $(${reduire_ax_plus_b(a,b)})$ est un facteur commun dans les deux termes :<br>`;  
            ...
            texte_corr += ` $\\iff (\\underline{${reduire_ax_plus_b(a,b)}})(( ${reduire_ax_plus_b(c,d)})-( ${reduire_ax_plus_b(a,b)}))=0$<br>`;  
            texte_corr += ` $\\iff (\\underline{${reduire_ax_plus_b(a,b)}})( ${reduire_ax_plus_b(c,d)}${ecriture_algebrique(-a)}x${ecriture_algebrique(-b)}))=0$<br>`;                           
