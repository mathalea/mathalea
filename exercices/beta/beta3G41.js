    ...
    for (let i = 0, texte, texte_corr, cpt = 0; i < this.nb_questions && cpt < 50;) {
      ...
      switch (liste_type_de_questions[i]) {
        case 1:
          ...
          objets_correction = [];
          for (i = 0; i < L.length; i++) {
            for (let elm of cube(L[i][0]+largeur+1,L[i][1]-longueur-1,L[i][2],90,0)) {
          ...
          objets_correction = [];
          for (i = 0; i < L.length; i++) {
            for (let elm of cube(L[i][0]+largeur+1,L[i][1]-longueur-1,L[i][2],0,0)) {
              objets_correction.push(elm);
            }
          }
          texte_corr += mathalea2d(params_correction, objets_correction)+ "<br>";
        ...
        case 2:
          ...
          params_correction = { xmin:longueur, ymin: 0, xmax: 2*longueur+1, ymax: 2.5*longueur, pixelsParCm: 20, scale: 1, mainlevee: false};
          objets_correction = [];
          for (i = 0; i < L.length; i++) {
            for (let elm of cube(L[i][0]+largeur+1,L[i][1]-longueur-1,L[i][2],0,0)) {
              objets_correction.push(elm);
          ...
          params_correction = { xmin:0, ymin: 0, xmax: longueur+1, ymax: 2.5*longueur, pixelsParCm: 20, scale: 1, mainlevee: false};
          objets_correction = [];
          for (i = 0; i < L.length; i++) {
            for (let elm of cube(L[i][0]+largeur+1,L[i][1]-longueur-1,L[i][2],90,0)) {
              objets_correction.push(elm);
